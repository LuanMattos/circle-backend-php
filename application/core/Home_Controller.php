...
class Home_Controller extends SI_Controller {
    ...
    private function _headers(){
        ...
        header('Access-Control-Allow-Headers:  Authorization, Client-Security-Token, Accept-Encoding, X-Auth-Token, X-Requested-With, Content-Type, Accept, x-Access-Token');
